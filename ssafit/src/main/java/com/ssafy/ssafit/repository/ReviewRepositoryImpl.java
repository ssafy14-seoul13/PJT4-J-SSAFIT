...
public class ReviewRepositoryImpl implements ReviewRepository{
	private static ReviewRepositoryImpl instance = new ReviewRepositoryImpl();
	...
	public Review addReview(String userId, String name, String videoId, String content) {
		Review review = new Review(userId, name, videoId, content);
	...
	public List<Review> searchByVideoId(String videoId) {
	    ...
	    for (Review r : reviewMap.values()) {
	        if (r.getVideoId().equals(videoId)) {
	        	User u = UserRepositoryImpl.getInstance().searchByUserId(r.getUserId());
	        	if (u != null) {
	                r.setName(u.getName());
	            }
	        	result.add(r);
